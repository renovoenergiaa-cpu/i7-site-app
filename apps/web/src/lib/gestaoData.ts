...
// Base Oficial de Produção - Exatamente os dois anúncios criados e configurados pelo usuário
export const INITIAL_UNITS: BuildingUnit[] = [
  {
    id: 'u-1790178985770',
    title: 'Loja comercial térrea de 80 m² com estacionamento e ótima área para vitrine',
    type: 'COMERCIAL',
    buildingName: 'Loja comercial térrea de 79 m² com estacionamento e ótima área para vitrine',
    unitNumber: 'loja 01',
    floor: 'Padrão',
    areaSqm: 80,
    rentValue: 7040,
    ...
    furnished: false,
    petFriendly: false,
    description: 'Loja comercial com 79,25 m², planta ampla e bem aproveitável, ideal para comércio, serviços, escritório, clínica, showroom ou outros segmentos que buscam visibilidade e conveniência para seus clientes. O imóvel conta com excelente frente e facilidade de acesso, além de estar inserido em um centro comercial moderno e bem localizado.',
    photos: [
      '/imoveis/uploads/foto-1.jpg',
      '/imoveis/uploads/foto-2.jpg',
      '/imoveis/uploads/foto-3.jpg',
      '/imoveis/uploads/foto-4.jpg'
    ],
    photosCount: 4,
    street: 'Avenida 3 de Março',
    number: '6120',
    complement: '',
    ...
    latitude: -23.448835,
    longitude: -47.376563,
    address: 'Avenida 3 de Março, 6120 - Conjunto Residencial Aparecidinha, Sorocaba - São Paulo',
    ownerName: 'i7 Inteligência Imobiliária',
    ownerEmail: 'admin@i7.com.br',
    ownerPhone: '(15) 98814-5050',
    createdAt: '2026-09-23T15:56:25.770Z',
    updatedAt: '2026-09-23T16:16:25.471Z'
  },
  {
    id: 'u-1790180780936',
    title: 'Ampla loja comercial de 220 m² com grande fachada e estacionamento',
    type: 'COMERCIAL',
    buildingName: 'Ampla loja comercial de 220 m² com grande fachada e estacionamento',
    unitNumber: 'loja 07',
    floor: 'Padrão',
    areaSqm: 220,
    rentValue: 19360,
    ...
    furnished: false,
    petFriendly: false,
    description: 'A maior unidade do empreendimento, com 222,87 m², indicada para empresas que necessitam de um espaço comercial amplo e de maior presença visual. A loja possui grande área interna e fachada extensa, permitindo diversas possibilidades de layout, além de contar com estacionamento compartilhado para clientes e excelente fluxo local.',
    photos: [
      '/imoveis/uploads/foto-1.jpg',
      '/imoveis/uploads/foto-2.jpg',
      '/imoveis/uploads/foto-3.jpg',
